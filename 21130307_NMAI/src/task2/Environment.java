...
import task2.Action;
import task2.Agent;
import task2.DynamicAction;
import task2.Environment;
import task2.EnvironmentState;
...
//			envState.setLocationState(this.envState.getAgentLocation(), Environment.LocationState.CLEAN);
...
//		}
	...
	public void step() {
		...
		if ((es.getLocationState(LOCATION_A) == LocationState.CLEAN)
				...
				&& (es.getLocationState(LOCATION_D) == LocationState.CLEAN) || point < 0)
